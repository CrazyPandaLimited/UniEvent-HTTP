...
//TEST_CASE("trivial get", "[client-basic]") {
...
//}
//
//TEST_CASE("trivial post", "[client-basic]") {
//    server::ServerSP echo;
//    uint16_t echo_port;
...
//}
//
//TEST_CASE("request larger than mtu", "[client-basic]") {
//    server::ServerSP echo;
//    uint16_t echo_port;
...
//}
//
//TEST_CASE("response larger than mtu", "[client-basic]") {
...
//}
//
//TEST_CASE("simple redirect", "[client-basic]") {
//    server::ServerSP to;
//    uint16_t to_port;
...
//}
//
////TEST_CASE("redirect chain", "[client-basic]") {
//    //server::ServerSP echo;
//    //uint16_t echo_port;
...
////}
//
////TEST_CASE("redirection-loop", "[client-basic]") {
